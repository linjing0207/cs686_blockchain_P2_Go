...
func TestExt(t *testing.T) {
	...
	mpt.Insert("b", "new")
	check_mpt("TestExt 011.1", mpt.Order_nodes(),"./mpt_tests/ext_011.txt", t)
	mpt.Delete("c")
	check_mpt("TestExt 011.2", mpt.Order_nodes(),"./mpt_tests/ext_011.txt", t)
	mpt.Delete("b")
	check_eq("TestExt 011.3", mpt.Order_nodes(), inserted_trie, t)
	v, _ := mpt.Get("aa")
	check_eq("TestExt 011.4", v, "banana", t)
